...
- **Genre**: Sci-Fi / Climate Thriller
- **Logline**: During catastrophic monsoon floods caused by extreme climate shifts, a lead meteorologist and a stranded engineer must protect a remote atmospheric research facility while transporting vital climate intelligence.
- **Tone**: Tense, emotional, grounded, cinematic
- **Target Budget**: $5,000,000
- **Target Shoot Days**: 12
...
| **0:20–0:40** | **Concept Intake Form** | *"I'll input our film concept: 'The Last Monsoon'—a climate sci-fi thriller about an atmospheric research team in flood-ravaged terrain. I'll set our target budget to \$5.0 Million across 12 shooting days, and hit **Generate Production Plan**."* | • Intake form inputs.<br>• Single concept entry.<br>• Target constraints set. |
...
| **1:30–1:55** | **Budget View** | *"Our **Budget Agent** calculates scene-linked costs, category allocations, and budget reconciliation against our \$5.0M target—identifying major cost drivers like specialized storm rigs and rain machines."* | • Scene-linked & category budgets.<br>• Variance tracking.<br>• Cost driver identification. |
| **1:55–2:15** | **Schedule View** | *"The **Schedule Agent** optimizes our 12-day shoot, grouping location moves and night blocks to minimize crew moves and budget overruns."* | • Multi-day shooting schedule.<br>• Location move optimization.<br>• Night block consolidation. |
